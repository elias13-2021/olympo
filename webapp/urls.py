...
urlpatterns = [
    ...
    path('detalleActividad/<int:codactividad>', detalleActividad),
    path('editarActividad/<int:codactividad>', editarActividad),
    ...
    path('detalleRegistro/<int:codregistro>', detalleRegistro),
    path('listadoRegistroTM1', listadoRegistroTM1),
    path('listadoRegistroTM2', listadoRegistroTM2),
]